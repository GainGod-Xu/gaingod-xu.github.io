...
- Li, Y., **Xu, H.**, Kumar, A., Wang, D., Heiss, C., Azadi, P., Hong, P. "TransPeakNet for Solvent-Aware 2D NMR Prediction via Multi-Task Pre-Training and Unsupervised Learning." *Communications Chemistry*, 2025.
- Wang, Y., Li, Y., Liu, L., Hong, P., **Xu, H.** "Advancing Drug Discovery with Enhanced Chemical Understanding via Asymmetric Contrastive Multimodal Learning." *J. Chem. Inf. Model.*, 2025.
...
- Meng, Z., Bai, Z., et al., Oldham, W. M., Meng, Z., **Xu, H.**, Loscalzo, J. "ExplainBind: Explainable Physicochemical Determinants of Protein-Ligand Binding via Non-Covalent Interactions." *bioRxiv*, 2026.
